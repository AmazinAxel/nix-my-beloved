<template>
    <Page image="/lfnw2026.png">
        <h1 class="text-[2rem] font-bold font-header leading-tight text-dark-4">i even did a talk about u</h1>
        <p class="gap-1 text-[1rem] italic font-body opacity-75 leading-tight text-dark-4">and it went really <span class="text-strikethrough">good</span> bad</p>
